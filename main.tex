...
\input{content/0-abstract} % Adds your abstract
\input{content/1-introduction} % Adds your introduction
\input{content/2-relwork} % Adds your literature review
\input{content/3-approach} % Adds your theory section 
\input{content/4-model} % Adds your model
\input{content/5-proof} % Adds your proof
\input{content/6-future} % Adds your future discussion
\input{content/7-partner} % Adds your partner
\input{content/8-conclusion} % Adds your conclusion
\input{content/9-bibliography} % Adds your references
